...
<body class="animsition">
                               ...
                               <div class="col-md-9">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title mb-3"><%= rs.getString("title") %></h4>
                                        <p> <%= rs.getString("body") %>
                                           
                                        </p>
                                        <h4 class="card-title mb-3"><%= rs.getString("user") %></h4>
 ...
 <script type="text/javascript" id="hcb"> 
     ...
     (function(){var s=document.createElement("script"),
         ...
         s.setAttribute("src", h+"/jread?page="+encodeURIComponent(l).replace("+","%2B")+"&opts=16862&num=10&ts=1531140037318");
