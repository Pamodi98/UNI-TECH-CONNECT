        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                         ...
                         <!-- ADD EVENT FORM -->            
                            <div class="col-lg-6" style="margin-left:15vw">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                         ...
                                         <form action="unicalanderprocess.jsp" method="post">
                                <div class="form-group">
                                    <label>event title</label>
                                    <input class="au-input au-input--full" type="text" name="title" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label>Date</label>
                                    <input class="au-input au-input--full" type="date" name="date" placeholder="">
                                </div>
                                          <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="des"  rows="9" placeholder="Content..." class="form-control"></textarea>
                                                </div>
                                            </div>
                           ...
                           <!-- DATA TABLE-->
                                <div class="table-responsive m-b-40">
                                   ...
                                   try{
                                       ...
                                       String query="select * from  unicalander where user='"+user+"'";
